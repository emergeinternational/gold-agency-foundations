...
const FALLBACK: Opportunity[] = [
  ...
  { type: "Showcase", title: "Creative Showcase", desc: "A curated presentation pathway for live performance, industry introductions, and creative visibility.", status: "Upcoming", mode: "media_opportunity", slug: "creative_showcase" },
  ...
  { type: "Partner Opportunity", title: "Media Fellowship", desc: "A mentorship and exposure pathway for media-focused talent, developed around professional readiness and visibility.", status: "Upcoming", mode: "media_opportunity", slug: "east_african_media_fellowship" },
