...
const faqs = [
  ...
  { q: "Does submitting guarantee I'll be represented?", a: "No. Submission is an application for review. Our team evaluates every application, but representation is selective and based on readiness, fit, and potential." },
  { q: "Is the academy connected to representation?", a: "They operate as separate tracks. Academy participation does not guarantee representation consideration, though exceptional performance may be noted." },
  ...
  { q: "How does talent booking work?", a: "Brands, event organizers, and production teams submit a booking inquiry through our platform. Our team matches project needs with available talent from the roster." },
  ...
  { q: "What does 'global reach' mean in practice?", a: "It means we prepare talent for international opportunities — through industry-standard training, cross-border partnerships, and positioning that resonates beyond local markets." },
];

export default function FAQ() {
  return (
    <Layout>
      <PageHero badge="FAQ" title="Straight Answers" subtitle="What you need to know about the platform, our processes, and how we operate — clearly and directly." />
