          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <Button type="submit" variant="gold" size="lg" disabled={submitting}>{submitting ? "Sending..." : "Send Message"}</Button>
                </form>
              )}
            </div>
            <div className="space-y-6">
              {[
                ...
                { icon: MapPin, label: "Based In", value: "New York City — internationally connected" },
              ].map(c => (
